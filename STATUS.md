...
| `amorefe.arcavila.com.br` — botão CTA "Ler agora por R$ 37" em verde menta | **Publicado em 2026-07-11 (commit `3b2087e`)** | A pedido do usuário, para dar mais destaque à venda: `#ctaBtn` trocou o fundo escuro/dourado por um gradiente verde menta (`#A7E3A0` → `#7FCB84`), texto escuro (`#173318`) para contraste, borda e sombra em tom verde. Validado com preview (`preview-botao-verde.html`, 3 opções testadas; escolhida a opção 2) |
